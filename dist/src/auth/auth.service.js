...
let AuthService = class AuthService {
    constructor(userRepository, cabinetRepository, jwtService) {
    ...
    async registerWithCabinet(name, password, role, cabinetName, cabinetType) {
        if (!Object.values(cabinet_entity_1.CabinetType).includes(cabinetType)) {
